...
class TripsApi {
  ...
  Future<Response<Trip>> tripsControllerAcceptTrip({ 
    required String id,
...
_responseData = rawData == null ? null : deserialize<Trip, Trip>(rawData, 'Trip', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [Trip] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Trip>> tripsControllerArriveTrip({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
...
_responseData = rawData == null ? null : deserialize<Trip, Trip>(rawData, 'Trip', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [Trip] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Trip>> tripsControllerCancelTrip({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
...
_responseData = rawData == null ? null : deserialize<Trip, Trip>(rawData, 'Trip', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [Trip] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Trip>> tripsControllerCompleteTrip({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
...
_responseData = rawData == null ? null : deserialize<List<Trip>, Trip>(rawData, 'List<Trip>', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [Trip] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Trip>> tripsControllerRejectTrip({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
