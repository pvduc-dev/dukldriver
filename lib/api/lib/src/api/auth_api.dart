...
class AuthApi {
  ...
  Future<Response<Driver>> authControllerGetMe({ 
...
_responseData = rawData == null ? null : deserialize<LoginResponseDto, LoginResponseDto>(rawData, 'LoginResponseDto', growable: true);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [RequestOtpResponseDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<RequestOtpResponseDto>> authControllerRequestOtp({ 
    required RequestOtpRequestDto requestOtpRequestDto,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
_bodyData=jsonEncode(requestOtpRequestDto);
    } catch(error, stackTrace) {
      throw DioException(
         requestOptions: _options.compose(
          _dio.options,
    ...
    RequestOtpResponseDto? _responseData;

    try {
final rawData = _response.data;
_responseData = rawData == null ? null : deserialize<RequestOtpResponseDto, RequestOtpResponseDto>(rawData, 'RequestOtpResponseDto', growable: true);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<RequestOtpResponseDto>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Object>> authControllerUpsertDeviceToken({ 
    required UpdateDeviceTokenRequestDto updateDeviceTokenRequestDto,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
_bodyData=jsonEncode(updateDeviceTokenRequestDto);
    } catch(error, stackTrace) {
      throw DioException(
         requestOptions: _options.compose(
          _dio.options,
